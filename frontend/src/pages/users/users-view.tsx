      ...
      <>
          ...
          <SectionMain>
            ...
            <CardBox>
                ...
                <>
                    <p className={'block font-bold mb-2'}>Registros Usuario</p>
                    <CardBox
                    ...
                    >
                        <div className='overflow-x-auto'>
                            ...
                            <tbody>
                            {users.registros_usuario && Array.isArray(users.registros_usuario) &&
                              users.registros_usuario.map((item: any) => (
                        ...
                        {!users?.registros_usuario?.length && <div className={'text-center py-4'}>No data</div>}
                    </CardBox>
                </>
